# change-other-files Specification

## Purpose
Display and summarize non-standard files that belong to a change directory, enabling operators to inspect auxiliary files like `.openspec.yaml`, `revisions.json`, and custom notes alongside standard change artifacts.
