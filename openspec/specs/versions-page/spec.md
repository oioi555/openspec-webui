# versions-page Specification

## Purpose
Show version/update status for OpenSpec WebUI and OpenSpec CLI inside Settings, with direct guidance for copyable update commands and release-note links.
